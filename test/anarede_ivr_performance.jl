@testset "IVR Model" begin
    ...
    @testset "qlim" begin
        ...
        pm = instantiate_model(data, ControlPowerFlow.ControlIVRPowerModel, ControlPowerFlow.build_pf_iv_performance);
        ...
        # TODO COMMENTED BECAUSE GEN REACTIVE CONTROLS ARE NOT IMPLEMENTED FOR IVR YET
